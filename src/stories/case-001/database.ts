 ...
 *
 * Data ported verbatim from scripts/seed-investigation.ts (lines 165–456).
 */
import type { InvestigationDatabaseSeed } from "@/stories/types";

const T = (h: number, m: number, s = 0) =>
  `2025-03-14 ${String(h).padStart(2, "0")}:${String(m).padStart(2, "0")}:${String(s).padStart(2, "0")}`;

export const CASE_001_DATABASE: InvestigationDatabaseSeed = {
  tables: [
    // ---------- SUSPECTS (4 rows) ----------
      ...
      rows: [
        {
          ...
          alibi:
            "States she left the Nexora building at 21:00 and drove home. Claims to have been home alone the rest of the evening reviewing quarterly reports.",
          notes:
            "CFO with signatory authority over vendor payments. Recently came under pressure from Elias regarding a vendor ledger audit. Separation negotiations were underway.",
        },
        {
          suspect_id: "S002",
          name: "Daniel Brooks",
          ...
          department: "Security",
          hire_date: "2015-09-03",
          status: "Person of Interest",
          badge_id: "DB-2208",
          phone: "+1-415-555-0177",
          alibi:
            "On duty the entire evening. Claims he was in the Security Control Room monitoring feeds and conducting a routine perimeter sweep between 22:30 and 23:00.",
          notes:
            "Unrestricted access to all locations including the Archive. Authorized to disable cameras for maintenance. Personal relationship with Maya Chen (undisclosed).",
        },
        {
          suspect_id: "S003",
          name: "Sofia Martinez",
          ...
          alibi:
            "Badge records show her on Floor 3 (Engineering Lab) from 19:00 to 23:20. Claims she was debugging the deployment pipeline and never went below Floor 1.",
          notes:
            "Holds remote administrative access to Nexora servers. Denied a promotion to Staff Engineer two weeks prior. No documented financial motive.",
        },
        {
          suspect_id: "S004",
          name: "Ryan Cole",
          ...
          alibi:
            "Was inside the building until 23:47. States he discovered the body during a final perimeter walk. No corroborating witness.",
          notes:
            "Holds Archive access for facility inspections. Filed a complaint against Elias Voss regarding unsafe staffing levels. Reported the death to emergency services at 23:52.",
        },
      ],
    },
    ...
    // ---------- VISITS (27 rows) — MOVEMENT THREAD ----------
    ...
    // ---------- CALLS (15 rows) — COMMUNICATION THREAD ----------
    {
      name: "calls",
      rows: [
    ...
    // ---------- TRANSACTIONS (31 rows) — FINANCIAL THREAD (TR-4817 mystery) ----------
    ...
    // ---------- MESSAGES (19 rows) — MESSAGE THREAD ----------
    ...
    // ---------- SECURITY_LOGS (22 rows) — SECURITY THREAD ----------
    ...
    // ---------- EVIDENCE (12 rows) — physical / catalog ----------
    {
      name: "evidence",
      rows: [
